...
class Ui_Database(object):
    def setupUi(self, Dialog):
        ...
        self.searchAbove.setGeometry(QtCore.QRect(30, 90, 191, 31))
        font = QtGui.QFont()
        ...
        self.buttonLimpiar.setGeometry(QtCore.QRect(430, 90, 211, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.searchBelow = QtWidgets.QPushButton(Dialog)
        self.searchBelow.setGeometry(QtCore.QRect(230, 90, 191, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.searchBelow.setFont(font)
        self.searchBelow.setIcon(icon1)
        self.searchBelow.setIconSize(QtCore.QSize(25, 25))
        self.searchBelow.setObjectName("searchBelow")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.searchBelow.setText(_translate("Dialog", "Search Below Tco"))
